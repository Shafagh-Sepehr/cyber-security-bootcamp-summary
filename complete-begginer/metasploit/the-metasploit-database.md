...
{% code title="Starting Postgresql" %}
```bash
...
\
If you run a Nmap scan using the `db_nmap` shown below, all results will be saved to the database. The db\_nmap command
...
{% code title="Querying the database for services" %}
```bash
